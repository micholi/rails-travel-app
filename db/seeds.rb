...
Trip.create(user_id: 1, city_id: 2, rating: 5, fave_attraction: "Trafalgar Square", comment: "One of my favorite cities ever! Hope to visit again someday.")
...
Trip.create(user_id: 2, city_id: 1, rating: 4, fave_attraction: "Rockefeller Center", comment: "Fun place to visit! But a little too crowded and fast-paced.")
